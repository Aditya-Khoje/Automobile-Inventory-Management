...
public class Home_supp extends javax.swing.JFrame {

    public String sup_name1;
    ...
    public Home_supp() {
        initComponents();
        this.setExtendedState(Home_supp.MAXIMIZED_BOTH);
    ...
    private void jToggleButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton10ActionPerformed
        ...
        POInvoice_supp rp = new POInvoice_supp();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Home_supp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
